...
def depth_value_to_depth_image(depth_values, is_gt = False):
    depth_values = depth_values.squeeze().numpy()
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # NeWCRFs model
    model = NewCRFDepth_v2(version=args.encoder, inv_depth=False, max_depth=args.max_depth, pretrained=args.pretrain)
    model.train()
    ...
    while epoch < args.num_epochs:
        ...
        for step, sample_batched in enumerate(dataloader.data):
            ...
            # save_img_dir = f'/home/dan/NeWCRFs/newcrfs/train_{timestamp}'
            # if not os.path.isdir(save_img_dir):
            #     os.makedirs(save_img_dir)
            
            # TVU.save_image(image, f'{save_img_dir}/{step}.jpg')    
